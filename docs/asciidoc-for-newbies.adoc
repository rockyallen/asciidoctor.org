...
- delimited blocks, including admonition blocks
...
If you're a programmer (or a writer with an inner geek), you'll likely prefer *VIM* or *Emacs*, both available across platforms.
All of these editors support http://asciidoc.org/#_editor_support[syntax highlighting for AsciiDoc].
...
----
**F**our scores and seven years ago...
----
